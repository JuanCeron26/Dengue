    ...
    <div class="max-w-[1400px] mx-auto">
      ...
      <nav class="flex items-center justify-between mb-8 animate-fade">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h1 class="text-2xl font-bold text-blue-900">Ecosalud</h1>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <main class="lg:col-span-9 animate-slide-right">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <!-- Usuarios -->
            <a href="usuarios.php" class="module-card p-6 block group" style="animation-delay: 0.1s;">
              <div class="icon-box mb-5 mx-auto">
                <img src="../gif/lider.gif" alt="Usuarios">
              </div>
            ...
            <!-- Gráficas -->
            <a href="graficas.php" class="module-card p-6 block group" style="animation-delay: 0.2s;">
              <div class="icon-box mb-5 mx-auto">
                <img src="../gif/grafico-de-linea.gif" alt="Gráficas">
              </div>
            ...
            <!-- Mapa -->
            <a href="mapa.php" class="module-card p-6 block group" style="animation-delay: 0.3s;">
              <div class="icon-box mb-5 mx-auto">
                <img src="../gif/ubicacion.gif" alt="Mapa">
              </div>
            ...
            <!-- Empresa -->
            <a href="empresa.php" class="module-card p-6 block group" style="animation-delay: 0.4s;">
              <div class="icon-box mb-5 mx-auto">
                <img src="../gif/ecologico.gif" alt="Empresa">
              </div>
            ...
            <!-- Control Biológico -->
            <a href="./front2.php" class="module-card p-6 block group" style="animation-delay: 0.5s;">
              <div class="icon-box mb-5 mx-auto">
                <img src="../gif/sostenibilidad.gif" alt="Control">
              </div>
            ...
            <!-- Reportes -->
            <a href="info.php" class="module-card p-6 block group" style="animation-delay: 0.6s;">
              <div class="icon-box mb-5 mx-auto">
                <img src="../gif/informe.gif" alt="Reportes">
              </div>
