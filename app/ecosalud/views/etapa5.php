        ...
        <div class="container mx-auto px-6 py-3">
            <div class="flex items-center justify-between max-w-4xl mx-auto">
                ...
                <div class="flex flex-col items-center stage-indicator cursor-pointer">
                    ...
                    <span class="mt-2 text-sm font-medium text-green-600">Etapa 4</span>
                </div>
                ...
                <div class="flex flex-col items-center stage-indicator cursor-pointer">
                    ...
                    <span class="mt-2 text-sm font-semibold text-indigo-600">Etapa 5</span>
                </div>
    ...
    <div class="flex">
        ...
        <aside class="w-72 bg-white shadow-2xl min-h-screen sticky top-32 self-start">
            ...
            <div class="mt-10 flex justify-center" id="btnSiguienteEtp">
                <button
                    class="group w-[80%] mx-auto relative overflow-hidden
