...
class controllerFoco extends modelFofo
{
    ...
    public function RegistrarFocoPotencial($post)
    {
        ...
        $datos = [
            "cod_territorio" => (int)$post['cod_territorio'], // por ahora el 3
    ...
    public function traerFocosActuales($cod_territorio, $ecosalud = false)
    {
        $cod = (int)$cod_territorio;
        return $this->GetFocosActuales($cod, $ecosalud);
    }
