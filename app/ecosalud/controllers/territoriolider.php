...
require_once "controllerEcosalud.php";
...
class TerritorioLiderController
{
    ...
    public function registrarNuevoLider($datos)
    {
        try {
            ...
            // Validar longitud del celular (10 dígitos)
            if (strlen($celular) > 10) {
                return ['success' => false, 'message' => '❌ El celular no puede tener más de 10 dígitos'];
            }
            ...
            // Validar longitud de la cédula (máximo 10 dígitos)
            if (strlen($cedula) > 10) {
                return ['success' => false, 'message' => '❌ La cédula no puede tener más de 10 dígitos'];
            }
            ...
            $ejec = $objEco->RegistrarControlActividad($territorio['cod_territorio'], 1);
            if ($ejec["success"] == true) {
                return [
                    'success' => true,
