...
document.addEventListener("DOMContentLoaded", () => {
    console.log('📦 Inicializando sistema de carga de datos...');
...
function aplicarFiltros() {
    ...
    console.log('🔍 Aplicando filtros:', { fecha, sitio, actividad });
...
console.log('📄 cargardatos.js cargado correctamente');