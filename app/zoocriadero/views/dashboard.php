...
<head>
    ...
    <title>Zoocriadero de Guppys</title>
...
<body class="bg-[var(--color-east-bay-50)] text-[var(--color-east-bay-950)] min-h-screen relative">
    ...
    <header class="sticky top-0 z-10 flex justify-between items-center px-8 py-4 bg-white/80 backdrop-blur-md shadow-lg border-b border-[var(--color-east-bay-100)] transition-shadow duration-300">
        ...
        <div class="flex items-center space-x-4">
            <div class="text-right">
                <p class="font-bold text-[var(--color-east-bay-700)]"><?php echo $nombreCompleto; ?></p>
                <p class="text-[var(--color-east-bay-500)] text-sm"><?php echo $rol; ?></p>
            </div>
    ...
    <p class="text-center text-xl text-gray-500">*El menu de navegación se encuentra pasando el cursor en la parte izquierda de la pantalla</p>
