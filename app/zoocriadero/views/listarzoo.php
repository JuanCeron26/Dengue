...
<label class="block mb-3">
  ...
  <select id="filterName" class="mt-1 block w-full rounded-md border p-2">
    ...
    <option value="Acuario La Primavera">Acuario La Primavera</option>
    <option value="Peces del Oriente">Peces del Oriente</option>
    <option value="Guppy House">Guppy House</option>
  </select>
</label>
...
<label class="block mb-3">
  ...
  <select id="filterEncargado" class="mt-1 block w-full rounded-md border p-2">
    <option value="">-- Todos --</option>
    <option value="Luisa Toro">Luisa Toro</option>
    <option value="Carlos Pérez">Carlos Pérez</option>
    <option value="Andrea Gómez">Andrea Gómez</option>
    <option value="Juan Ortiz">Juan Ortiz</option>
  </select>
</label>
...
<table class="w-full border-collapse bg-white rounded-lg shadow">
      ...
      <tr class="hover:bg-slate-50" data-id="2">
        ...
        <td class="py-3 text-center">
          <div class="flex justify-center gap-2">
            <img src="../../../src/iconos/zoom.png" title="Ver" class="btn-view w-5 h-5 cursor-pointer hover:scale-110 transition">
            <img src="../../../src/iconos/edit.svg" title="Editar" class="btn-edit w-5 h-5 cursor-pointer hover:scale-110 transition">
            <img src="../../../src/iconos/trash-2.svg" title="Anular" class="btn-delete w-5 h-5 cursor-pointer hover:scale-110 transition">
            <img src="../../../src/iconos/upload.svg" title="Exportar" class="btn-export w-5 h-5 cursor-pointer hover:scale-110 transition">
          </div>
        </td>
      </tr>
  ...
  <script src="../../../src/js/listarzoo.js"></script>
</body>
</html>
