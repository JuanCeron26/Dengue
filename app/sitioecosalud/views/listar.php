...
<body class="bg-gray-100 min-h-screen">
    <div class="container mx-auto p-6 max-w-7xl">
        ...
        <div class="bg-white rounded-lg shadow-lg p-5 mb-6">
            <div class="flex items-center gap-6">
                ...
                <div class="flex gap-2">
                    <button id="btnApplyFilters" class="bg-eco-green-dark hover:bg-eco-green-light text-white px-5 py-2 rounded-lg font-semibold transition-all shadow-md">
                        <i class="fas fa-search mr-1"></i>Buscar
                    </button>
                    <button id="btnClearFilters" class="bg-gray-500 hover:bg-gray-600 text-white px-5 py-2 rounded-lg font-semibold transition-all shadow-md">
        ...
        <div class="flex items-center justify-between mb-4">
            ...
            <button id="btnRefresh" class="text-eco-green-dark hover:text-eco-green-light font-semibold">
                            ...
                            <div class="bg-white rounded-xl shadow-lg overflow-hidden card-hover">
                                ...
                                <div class="p-5">
                                    ...
                                    <div class="grid grid-cols-3 gap-2 pt-3 border-t border-gray-200">
                                        <button class="btn-view-details bg-eco-green-light hover:bg-eco-green-dark text-white px-3 py-2 rounded-lg transition-all text-sm font-semibold"
                                            data-sitio='<?= $sitioJson ?>'
                                            title="Ver Detalles">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <button class="btn-edit-site bg-eco-green-dark hover:bg-eco-green-light text-white px-3 py-2 rounded-lg transition-all text-sm font-semibold"
                                            data-sitio='<?= $sitioJson ?>'
                                            title="Editar">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button class="btn-deactivate-site bg-red-500 hover:bg-red-600 text-white px-3 py-2 rounded-lg transition-all text-sm font-semibold"
                                            data-cod="<?= htmlspecialchars($sitio['cod_sitioeco']) ?>"
                                            data-nombre="<?= htmlspecialchars($sitio['nombre_sitio']) ?>"
                                            title="Anular">
            ...
            <div class="col-span-4">
                <div class="bg-white rounded-lg shadow-lg p-6 sticky top-6">
                    ...
                    <div id="editForm" class="hidden">
                        ...
                        <!-- Action Buttons -->
                        <div class="flex gap-3">
                            <button id="btnSaveSite" class="flex-1 bg-eco-green-dark hover:bg-eco-green-light text-white px-4 py-3 rounded-lg font-semibold transition-all shadow-md">
                                <i class="fas fa-save mr-2"></i>Guardar
                            </button>
                            <button id="btnCancelEdit" class="flex-1 bg-gray-400 hover:bg-gray-500 text-white px-4 py-3 rounded-lg font-semibold transition-all shadow-md">
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div class="bg-gradient-to-r from-eco-green-dark to-eco-green-light p-6 rounded-t-2xl">
                <div class="flex items-center justify-between">
                    ...
                    <button id="btnCloseDetailsModal" class="text-white hover:text-gray-200 transition-all">
            ...
            <div class="p-6">
                ...
                <!-- Botón cerrar -->
                <button id="btnAcceptModal" class="w-full bg-eco-green-dark hover:bg-eco-green-light text-white px-6 py-3 rounded-lg font-bold transition-all shadow-lg">
