...
<aside id="aside"
    ...
    <div class="flex flex-col items-center gap-10">
        ...
        <a href="../../zoocriadero/views/dashboard.php" class="group flex flex-col items-center">
        ...
        <a href="consulta3.php" class="group flex flex-col items-center">
            <div class="transition-all duration-300 group-hover:scale-125 group-hover:-translate-y-1">
